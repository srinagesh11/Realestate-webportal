 ...
 */
@WebFilter(filterName = "agentLoginValidationFilter")
public class AgentLoginValidationFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		System.out.println("Filter agentLoginValidate");
		...
		if (name == null || "".equals(name)
            ...
            request.getRequestDispatcher("view/agent.jsp").include(request, response);
