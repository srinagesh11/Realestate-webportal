...
@WebFilter(filterName = "governmentloginvalidationfilter")
public class governmentloginvalidationfilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		System.out.println("Filter governmentLoginValidate");
		...
		if (name == null || "".equals(name)
            ...
            request.getRequestDispatcher("view/governmentofficial.jsp").include(request, response);
