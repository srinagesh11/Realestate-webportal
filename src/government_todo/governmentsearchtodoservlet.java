 ...
 */
@WebServlet("/governmentsearchtodoservlet.do")
public class governmentsearchtodoservlet extends HttpServlet {
	...
	private static final long serialVersionUID = 1L;
      private List<listing> searchList =null;
  	...
  	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			request.getRequestDispatcher("view/governmenttodoSearch.jsp").forward(request, response);
