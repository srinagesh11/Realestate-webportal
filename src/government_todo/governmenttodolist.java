...
@WebServlet("/governmenttodolist.do")
public class governmenttodolist extends HttpServlet {
	private static final long serialVersionUID = 1L;
   static final Logger LOG = LoggerFactory.getLogger(governmenttodolist.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			request.getRequestDispatcher("view/governmenttodoList.jsp").forward(request, response);
