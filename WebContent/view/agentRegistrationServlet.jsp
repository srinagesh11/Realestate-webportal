...
$('submit').click(function () {
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
 	...
 	<form action="agentRegistrationServlet.do" method="post" class="form-signin">
		<p>
			...
			<input type="text" class="form-control" name="experience" placeholder="experience" required="" autofocus="" />
