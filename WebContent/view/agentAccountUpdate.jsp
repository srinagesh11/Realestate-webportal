...
<!--  <div class="row">  
 	...
 	<form action="agentAccountUpdate.do" method="post" class="form-signin">
		<p>
			<font color="red">${error}</font>
			...
			<input type="text" class="form-control" name="experience" placeholder="Experience" required="" autofocus="" value="${u.experience}" />
			<input type="text" class="form-control" name="contact" placeholder="Contact" required="" autofocus="" value="${u.contact}" />
